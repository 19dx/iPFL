...
nohup python -u main.py --alg "fedamp" --gpu "1" --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/fedamp_${START_TIME}.log &
nohup python -u main.py --alg "ditto" --gpu "1" --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/ditto_${START_TIME}.log &
nohup python -u main.py --alg "fedfomo" --gpu "1" --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/fedfomo_${START_TIME}.log &
nohup python -u main.py --alg "pfedgraph" --gpu "1" --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/pfedgraph_cosine_${START_TIME}.log &
nohup python -u main.py --alg "ipfl" --gpu "1" --C $C --ipfl_lam $lam --ipfl_eta $eta --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/ipfl_${START_TIME}.log &

## ============= Dropout =============
# dir_dir=${dir_path}/baselines_dropout
# if [ ! -d $dir_dir ]; then
#     mkdir $dir_dir
# else
#     echo "dir exists"
# fi
# dropout_type='IR-prob'
# # python main.py --alg "fedfomo" --gpu "1" --dropout --dropout_type $dropout_type --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta 
# for dropout_type in 'IR-prob'
# do
    # nohup python -u main.py --alg "fedavg" --gpu "2" --dropout --dropout_type $dropout_type --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/fedavg_${dropout_type}_${START_TIME}.log &
    # nohup python -u main.py --alg "fedprox" --gpu "2" --dropout --dropout_type $dropout_type --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/fedprox_${dropout_type}_${START_TIME}.log &
    # nohup python -u main.py --alg "fedamp" --gpu "5" --dropout --dropout_type $dropout_type --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/fedamp_${dropout_type}_${START_TIME}.log &
    # nohup python -u main.py --alg "ditto" --gpu "5" --dropout --dropout_type $dropout_type --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/ditto_${dropout_type}_${START_TIME}.log &
    # nohup python -u main.py --alg "cfl" --gpu "5" --dropout --dropout_type $dropout_type --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/cfl_${dropout_type}_${START_TIME}.log &
    # nohup python -u main.py --alg "fedfomo" --gpu "1" --dropout --dropout_type $dropout_type --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/fedfomo_${dropout_type}_${START_TIME}.log &
    # nohup python -u main.py --alg "pfedgraph" --gpu "5" --dropout --dropout_type $dropout_type --C $C --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/pfedgraph_cosine_${dropout_type}_${START_TIME}.log &
#     nohup python -u main.py --alg "ipfl" --gpu "3" --dropout --dropout_type $dropout_type --C $C --ipfl_lam $lam --ipfl_eta $eta --dataset $dataset --model $model --partition $data_partition --n_parties $client --num_local_iterations $iternum --beta $beta > $dir_dir/ipfl_${dropout_type}_${START_TIME}.log &
# done
